  ...
  cin >> i;
   ...
   if (i == 1) {
    ...
    if(i==4){
        ...
        cout << p5.getName() << " " << p5.getSurname() << " " << p5.getYear() << endl;
         cout << "Enter the age: ";
        cin >> year;
        cout << "\n";
        ...
        cout << p6.getName() << " " << p6.getSurname() << " " << p6.getYear() << endl;
...
if (i==7){
        ...
        cout << p7.getName() << " " << p7.getSurname() << " " << p7.getYear() << endl;
         cout << "Enter the age: ";
        cin >> year;
        cout << "\n";
        ...
        cout << p8.getName() << " " << p8.getSurname() << " " << p8.getYear() << endl;
